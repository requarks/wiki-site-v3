<template>
  <div class="bg-gray-900 py-16 sm:py-24 border-b border-solid border-gray-700">
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
      <div class="grid grid-cols-1 items-center gap-x-8 gap-y-16 lg:grid-cols-2">
        ...
        <div class="-mx-6 grid grid-cols-2 gap-0.5 overflow-hidden sm:mx-0 sm:rounded-2xl md:grid-cols-3">
          <div class="bg-white/5 hover:bg-white/10 p-8 sm:p-10 flex items-center justify-center">
          ...
          <div class="bg-white/5 hover:bg-white/10 p-6 sm:p-10 flex items-center justify-center">
